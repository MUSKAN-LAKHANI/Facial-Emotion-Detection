...
#
label_l1 = tk.Label(root, text="A Emotion AI solutions and services", font=("Times New Roman", 35, 'bold'),
...
exit = tk.Button(root, text="Exit", command=window, height=1,width=15, font=('times',25, ' bold '), bg="Black",fg="white")
